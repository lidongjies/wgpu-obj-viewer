...
use crate::camera::{Camera, CameraController, CameraStaging, CameraUniform};
use crate::model::{DrawModel, Model, ModelVertex};
use crate::resource::load_model;
use crate::texture;
use crate::vertex::{Instance, InstanceRaw, VertexDesc};
...
impl Renderer {
    ...
    pub async fn new(window: &Window) -> Self {
        ...
        let (device, queue) = adapter
            .request_device(
                &wgpu::DeviceDescriptor {
                    ...
                    // WebGL doesn't support all of wgpu features, so if
        ...
        let camera_bing_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                label: Some("camera_bing_group_layout"),
        ...
        let camera_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("camera_bing_group"),
            layout: &camera_bing_group_layout,
        ...
        let render_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                ...
                bind_group_layouts: &[&texture_bind_group_layout, &camera_bing_group_layout],
        ...
        let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            vertex: wgpu::VertexState {
                module: &shader,
                entry_point: "vs_main",
                buffers: &[ModelVertex::desc(), InstanceRaw::desc()], // what type of vertices we want to pass to the vertex shader.
            },
